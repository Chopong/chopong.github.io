...
begin:"@[A-Za-z]+"}]}}})());hljs.registerLanguage("clojure",(()=>{"use strict";return e=>{
...
starts:{end:/$/,subLanguage:"clojure"}}]})})());hljs.registerLanguage("sas",(()=>{"use strict";function e(...e){return"("+((e=>{
const t=e[e.length-1]
;return"object"==typeof t&&t.constructor===Object?(e.splice(e.length-1,1),t):{}
...
},...a],illegal:/\/\/|->|=>|\[\[/}}})());hljs.registerLanguage("latex",(()=>{"use strict";function e(...e){
return"("+((e=>{const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
})(e).capture?"":"?:")+e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null
